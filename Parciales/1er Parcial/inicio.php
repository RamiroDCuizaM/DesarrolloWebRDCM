...
<body>
     <div class="conIni">
        ...
        <div class="contenido">
            ...
            <div class="menuM">
                <div class="infoM">
                    <button class="buttonL" style="background-color: white; border: 1px solid white;"><img src="PrimerParcial/inicio.png" class="imagenL"> <a href="inicio.php" style="margin-top: -15px;"><h3>Inicio</h3></a></button>
                    <h5 style="margin-top: -1px; margin-left: 10px;">Primer Examen Parcial</h5> 
                </div>
                <div class="targetasM">
                    <div class="tM">
